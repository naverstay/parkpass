    ...
    !(function (t, i) {
      ...
      return (
                ...
                if (
                  ...
                  if (
                    ...
                    !1 !== m &&
                      ...
                      (u = void 0 === m.right || m.right));
                    var d =
                        (-1 === this.directionX && p) || (1 === this.directionX && u)
                          ? this.wrapperWidth
                          : 0,
                      f =
        ...
        (PPPPicker.prototype._startProbe = function () {
          z(this.probeTimer),
            (this.probeTimer = H(function t() {
              ...
              e.trigger('scroll', i),
                e.isInTransition ? (e.probeTimer = H(t)) : e.trigger('scrollEnd', i);
            }));
          var e = this;
        }),
        ...
        (PPPPicker.prototype.scrollTo = function (t, i) {
          ...
          (this.x !== t || this.y !== i) &&
            ((this.isInTransition =
              this.options.useTransition && 0 < e && (t !== this.x || i !== this.y)),
        ...
        (PPPPicker.prototype.getComputedPosition = function () {
          ...
          return (
            (e = this.options.useTransform
              ? ((i = +((t = t[S.transform].split(')')[0].split(', '))[12] || t[4])),
                +(t[13] || t[5]))
